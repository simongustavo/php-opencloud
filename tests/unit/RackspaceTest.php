...
class RackspaceTest extends TestCase
{
    ...
    {
        $this->builder
            ->createService('ObjectStore\\v1', 1, ['catalogName' => 'cloudFiles', 'catalogType' => 'object-store'])
            ->shouldBeCalled()
    ...
    {
        $this->builder
            ->createService('ObjectStoreCDN\\v1', 1, ['catalogName' => 'cloudFilesCDN', 'catalogType' => 'rax:object-cdn'])
            ->shouldBeCalled()
